def fcfs_sequential(jobs):
    # Sort jobs based on their index (job ID)
...
start_times, completion_times, turnaround_times, waiting_times, makespan, avg_waiting_time, avg_turnaround_time = fcfs_sequential(jobs)
